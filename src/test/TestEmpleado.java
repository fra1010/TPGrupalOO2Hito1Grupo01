...
public class TestEmpleado 
{
    public static void main(String[] args) 
    {
    	...
    	empleado1.agregarEmpleadoCocinero(
    			"pepe", "Armando", 2551546,
    	...
    	empleado1.agregarEmpleadoCajero(
    			"Jose", "Fernandez", 3333546,
    			LocalDate.of(2000, 10, 6),
        ...
        for (Cocinero cocinero : EmpleadoAbm.getInstance()
        		.traerCocinerosPorEspecialidad("fritos")) 
        {
        ...
        for (Cajero cajero : EmpleadoAbm.getInstance()
        		.traerCajerosPorTurno("tarde")) 
        {
        ...
        for (Empleado empleado : EmpleadoAbm.getInstance()
        		.traerEmpleadosPorFechaNacimiento(
        				LocalDate.of(2000, 10, 6))) 
        {
        ...
        System.out.println(
        		EmpleadoAbm.getInstance()
        		.traerEmpleadoConMasDeAniosDeAntiguedad(
        ...
        for (Cajero cajero : EmpleadoAbm.getInstance()
        		.traerCajerosEntreFechasDeIngreso(
        ...
        for (Empleado empleado : EmpleadoAbm.getInstance()
        		.traerEmpleadosEntreFechasDeNacimiento(
